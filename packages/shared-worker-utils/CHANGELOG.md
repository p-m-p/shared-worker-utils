...
- 33dd9f0: BREAKING CHANGE: Renamed PortManager.getStaleClientCount() to getStaleCount() for API consistency
...
- 0ac33e4: Add stale client management with optional auto-removal and manual cleanup
